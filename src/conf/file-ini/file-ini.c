...
static int nxs_fw_ctl_conf_file_ini_prep(nxs_cfg_t cfg);
static int nxs_fw_ctl_conf_file_ini_post(nxs_cfg_t cfg);
...
nxs_cfg_par_t cfg_par[] =
{
	...
	{nxs_string("loglevel"),			&nxs_fw_ctl_cfg.log_level,		NULL,				NXS_CFG_TYPE_INT,		0,	31,	NXS_CFG_REQUIRED_NO,	NXS_CFG_TWICE_DEFINITION_NO},
	{nxs_string("logpath"),				&nxs_fw_ctl_cfg.log_path,		NULL,				NXS_CFG_TYPE_STRING,		0,	0,	NXS_CFG_REQUIRED_YES,	NXS_CFG_TWICE_DEFINITION_NO},
...
void nxs_fw_ctl_conf_file_ini_init(nxs_cfg_t *cfg, nxs_fw_ctl_cfg_ctx_t *cfg_ctx)
{

	cfg->cfg_par       = cfg_par;
	cfg->prep_function = &nxs_fw_ctl_conf_file_ini_prep;
	cfg->post_function = &nxs_fw_ctl_conf_file_ini_post;

	nxs_string_init(&cfg->cfg_path);
}

nxs_fw_ctl_err_t nxs_fw_ctl_conf_file_ini_runtime(nxs_cfg_t cfg, nxs_fw_ctl_cfg_ctx_t *cfg_ctx)
{
 ...
 *
static int nxs_fw_ctl_conf_file_ini_emails(nxs_string_t *opt, nxs_string_t *val, nxs_cfg_par_t *cfg_par)
{
