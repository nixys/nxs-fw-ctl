...
static nxs_fw_ctl_err_t nxs_fw_ctl_u_dals_make_makefiles(nxs_fw_ctl_u_dals_t *u_ctx);
static nxs_fw_ctl_err_t nxs_fw_ctl_u_dals_make_genfiles(nxs_fw_ctl_u_dals_t *u_ctx);
...
{
	{nxs_string("subdals.h_tpl"),		nxs_string("" NXS_FW_CTL_U_DALS_TPL_D_FILENAME "-subdals.h")},
	{nxs_string("typedefs.h_tpl"),		nxs_string("" NXS_FW_CTL_U_DALS_TPL_D_FILENAME "-typedefs.h")},
	{nxs_string("dal.c_tpl"),		nxs_string("" NXS_FW_CTL_U_DALS_TPL_D_FILENAME ".c")},
	{nxs_string("dal.h_tpl"),		nxs_string("" NXS_FW_CTL_U_DALS_TPL_D_FILENAME ".h")},
...
nxs_fw_ctl_err_t nxs_fw_ctl_u_dals_add(nxs_fw_ctl_u_dals_t *u_ctx)
{
	nxs_fw_ctl_err_t rc;
	...
	if(nxs_fw_ctl_u_dals_make_makefiles(u_ctx) != NXS_FW_CTL_E_OK) {

		nxs_error(rc, NXS_FW_CTL_E_ERR, error);
	}

	if(nxs_fw_ctl_u_dals_make_genfiles(u_ctx) != NXS_FW_CTL_E_OK) {
...
static nxs_fw_ctl_err_t nxs_fw_ctl_u_dals_make_makefiles(nxs_fw_ctl_u_dals_t *u_ctx)
{
	...
	for(i = 0; nxs_string_len(&makefiles[i].src) > 0; i++) {
		...
		nxs_string_printf_dyn(&tpl_path,
		                      "%r/" NXS_FW_CTL_DIR_ADD_TPL "/" NXS_FW_CTL_DIR_DALS "/%r",
...
static nxs_fw_ctl_err_t nxs_fw_ctl_u_dals_make_genfiles(nxs_fw_ctl_u_dals_t *u_ctx)
{
	...
	for(i = 0; nxs_string_len(&genfiles[i].src) > 0; i++) {
		...
		nxs_string_printf_dyn(
		        &tpl_path, "%r/" NXS_FW_CTL_DIR_ADD_TPL "/" NXS_FW_CTL_DIR_DALS "/%r", &nxs_fw_ctl_cfg.tpls_path, &genfiles[i].src);
