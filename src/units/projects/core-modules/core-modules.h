...
nxs_fw_ctl_err_t			nxs_fw_ctl_u_projects_core_modules_using_get_distrib		(nxs_fw_ctl_u_projects_core_modules_t *u_ctx, size_t i, nxs_string_t *name, nxs_string_t *link_opts, nxs_string_t *includes);
